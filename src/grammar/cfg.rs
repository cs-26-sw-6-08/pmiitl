...
pub const ID_TERMINAL_DECIMAL: u32 = 0x0008;
...
pub const ID_TERMINAL_TIMEUNIT: u32 = 0x000C;
/// The unique identifier for terminal `POWERUNIT`
pub const ID_TERMINAL_POWERUNIT: u32 = 0x000D;
/// The unique identifier for terminal `BOOL`
pub const ID_TERMINAL_BOOL: u32 = 0x000E;
/// The unique identifier for terminal `TIME`
pub const ID_TERMINAL_TIME: u32 = 0x000F;
...
pub trait Visitor {
    ...
    fn on_terminal_decimal(&self, node: &AstNode) {}
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x0008 => visitor.on_terminal_decimal(&node),
        0x000A => visitor.on_terminal_number(&node),
        0x000B => visitor.on_terminal_string(&node),
        0x000C => visitor.on_terminal_timeunit(&node),
        ...
        0x0014 => visitor.on_variable_expr_a1(&node),
        0x0015 => visitor.on_variable_expr_a2(&node),
        0x0016 => visitor.on_variable_expr_a3(&node),
        0x0017 => visitor.on_variable_expr(&node),
        0x0018 => visitor.on_variable_expr_v1(&node),
        0x0019 => visitor.on_variable_expr_v2(&node),
        0x001A => visitor.on_variable_expr_v3(&node),
        0x001B => visitor.on_variable_expr_v4(&node),
        0x001C => visitor.on_variable_expr_v5(&node),
        0x001D => visitor.on_variable_expr_v6(&node),
        0x001E => visitor.on_variable_expr_v7(&node),
        0x001F => visitor.on_variable_expr_v8(&node),
        0x0020 => visitor.on_variable_function(&node),
        0x0021 => visitor.on_variable_aggregate(&node),
        0x0022 => visitor.on_variable_function_expr(&node),
        0x0023 => visitor.on_variable_function_expr_v1(&node),
        0x0024 => visitor.on_variable_function_expr_v2(&node),
        0x0025 => visitor.on_variable_function_expr_v3(&node),
        0x0026 => visitor.on_variable_function_expr_v4(&node),
        0x0027 => visitor.on_variable_function_expr_v5(&node),
        0x0028 => visitor.on_variable_function_expr_v6(&node),
        0x0029 => visitor.on_variable_function_expr_v7(&node),
        0x002A => visitor.on_variable_function_expr_v8(&node),
        0x002B => visitor.on_variable_member(&node),
        _ => ()
    };
}

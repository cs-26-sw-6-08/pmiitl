...
fn function_rules() {
    ...
    for cur_type in all {
        ...
        match cur_type.clone(){
            ...
            FunctionType::Sumtime => assert_eq!(yes_expr.unwrap(), vec![Operation::TimeFunction { idx: 1, function_type: AggregateType::Sum, history: Vec::new(), max_bound: None }, Operation::AggregateFunction { idx: 2, function_type: AggregateType::Sum }, Operation::Number(10_000)]),
            FunctionType::Avgtime => assert_eq!(yes_expr.unwrap(), vec![Operation::TimeFunction { idx: 1, function_type: AggregateType::Avg, history: Vec::new(), max_bound: None }, Operation::AggregateFunction { idx: 2, function_type: AggregateType::Sum }, Operation::Number(10_000)]),
